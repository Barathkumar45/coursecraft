...
const AddCoursemed = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post('http://localhost:8080/api/medicine/courses/addmed', formData, {
        headers: {
  ...
  return (
    <div className="add-course-container">
       <h1 className="page-title">Add Medicine Courses</h1>
