...
import './AgriDetailsForm.css';

const AgriDetailsForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
        const response = await axios.post('http://localhost:8080/api/agri-details/addagridetails', formData, {
  ...
  return (
    <div className="agri-details-form-container">
      <h2 className="agri-details-form-title">Add Agriculture Course Details</h2>
...
export default AgriDetailsForm;
